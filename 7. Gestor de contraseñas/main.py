...
def inicio():
    ...
    if len(comprobar) == 0:
        ...
        constrasena_maestra = getpass('Ingrese su contraseña maestra: ')
        respuesta = Usuario.registrar(nombre, apellido, constrasena_maestra)
        ...
        constrasena_maestra = getpass('Ingrese su contraseña maestra: ')
        respuesta = Usuario.comprobar_contrasena(1, constrasena_maestra)
        if len(respuesta) == 0:
...
def menu():
    while True:
        ...
        if opcion == '1':
            ...
            print('No ingresó un opción válida')
